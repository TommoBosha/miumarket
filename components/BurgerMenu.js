...
const BurgerMenu = ({ navbar, setNavbar }) => {
  ...
  function fetchCategories() {
    axios.get("/api/categories/").then((result) => {
      const categoriesWithoutParent = result.data.filter(
  ...
  return (
    <div>
      <div
        className="fixed inset-0 bg-black w-full h-full bg-opacity-50 z-10"
        style={backdropStyle}
        onClick={() => setNavbar(false)}
      ></div>
      <div
        className="fixed top-[10px] md:top-0  left-5 md:left-0  md:w-[320px] h-menu md:h-full w-menu  z-20 bg-menu rounded-[20px] md:rounded-none"
        style={modalStyle}
      >
        <button
          onClick={() => setNavbar(!navbar)}
          className="absolute z-30 top-2 right-4 mr-1 text-black"
        >
          <XMarkIcon className="h-[17px] w-[17px] md:h-[20px] md:w-[20px]" />
        </button>

        <div className="flex items-center justify-star pt-7 px-[34px]">
          <Image
            src="/images/logo.svg"
            alt="Логотип MIU Market"
            width={134}
            height={52}
            className="  w-[117px] h-[57px] md:w-[134px] md:h-[52px]    "
          />
        </div>

        <ul className="text-left h-auto  justify-center flex  flex-col px-6 pt-2 pb-32 w-72">
          <li className="  text-black  custom-li items-center">
            <Link
              href="/"
              onClick={() => setNavbar(!navbar)}
            ...
            >
              ...
              >
                <path
                  d="M0.152344 12.3783L12.1526 0.378081C12.6568 -0.126027 13.4743 -0.126027 13.9785 0.378081L25.9788 12.3783H23.3961V22.7089C23.3961 23.4221 22.818 24.0002 22.1048 24.0002H15.6482V14.961H10.4829V24.0002H4.02631C3.31313 24.0002 2.73499 23.4221 2.73499 22.7089V12.3783H0.152344Z"
                  fill="black"
                />
              </svg>
              Головна
          ...
          <li className=" text-black  custom-li" onClick={handleCatalogClick}>
            <a className=" uppercase text-base cursor-pointer" style={{ fontWeight: "600" }}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="18"
          ...
          <li className="  text-black   custom-li">
            ...
            >
              ...
              >
                <path
                  d="M3.31913 10.1739C4.0894 13.8362 6.01341 17.1809 8.79765 19.6895L11.9778 17.8553C12.3751 17.6268 12.8491 17.657 13.208 17.888C14.3689 18.6527 15.6788 19.2501 17.0956 19.6321C17.7271 19.8024 18.097 20.4453 17.9267 21.0769L16.8527 25.0598C16.6824 25.6913 16.0394 26.0612 15.4079 25.8909C4.72247 23.0095 -1.60225 12.0145 1.27909 1.32912C1.44939 0.697553 2.09802 0.329245 2.72389 0.498013L6.70674 1.57199C7.33831 1.7423 7.70815 2.38524 7.53785 3.0168C7.15582 4.43356 7.01366 5.86617 7.09103 7.25421C7.11034 7.68056 6.89809 8.10551 6.50077 8.33406L3.31913 10.1739Z"
                  fill="black"
                />
              </svg>
              Контакти
          ...
          <li className="  text-black custom-li ">
            ...
            >
              ...
              >
                <path
                  d="M8.64914 8.81442C10.9171 8.81442 12.754 6.97238 12.754 4.70958C12.754 2.44165 10.9171 0.604736 8.64914 0.604736C6.38122 0.604736 4.5443 2.44165 4.5443 4.70958C4.5443 6.97238 6.38122 8.81442 8.64914 8.81442ZM8.64914 10.8668C5.91429 10.8668 0.439453 12.2368 0.439453 14.9717V17.0241H16.8588V14.9717C16.8588 12.2368 11.384 10.8668 8.64914 10.8668Z"
                  fill="black"
                />
                <path
                  d="M8.14844 19.5739V20.0739H8.64844H25.0678H25.5678V19.5739V17.5215C25.5678 16.6542 25.1298 15.9319 24.5087 15.3589C23.8911 14.789 23.0601 14.3337 22.1743 13.9793C20.4034 13.2708 18.2879 12.9167 16.8581 12.9167C15.4284 12.9167 13.3128 13.2708 11.542 13.9793C10.6562 14.3337 9.82514 14.789 9.20755 15.3589C8.58648 15.9319 8.14844 16.6542 8.14844 17.5215V19.5739ZM16.8581 11.8642C19.4026 11.8642 21.463 9.79792 21.463 7.25939C21.463 4.71532 19.4022 2.65454 16.8581 2.65454C14.3141 2.65454 12.2533 4.71532 12.2533 7.25939C12.2533 9.79792 14.3137 11.8642 16.8581 11.8642Z"
                  fill="black"
                  stroke="#F4F4F4"
                />
              </svg>
