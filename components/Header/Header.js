...
function Header({ setIsAuthModalOpen }) {
  ...
  return (
    <header className=" container container-header   md:max-w-[1279px] xl:max-w-[1440px]">
      <nav className="flex items-center justify-between shadow-[bottom] py-[16px] md:py-[22px]">
