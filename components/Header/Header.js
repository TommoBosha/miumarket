    ...
    <nav className="flex items-center justify-between shadow-[bottom]" >
        ...
        <Link href="/">
            <Image
                ...
                width={134}
                height={52}
                className={`md:mr-5 xl:mr-[86px] xl:w-[180px] xl:h-[70px] ${isMobile && 'hidden'}`}
            />
        </Link>

        {/* Номер телефону */}
        <p className={`md:text-[20px] md:leading-[16.78px] md:font-bold md:text-primary md:mr-6
        xl:text-[22px] xl:leading-[18.45px] xl:mr-[82px] ${isMobile && 'hidden'}`}
       >
            +380 66 523 23 07
        </p>
